		...
		<div class="container-wrap">
			...
			<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
				<div class="text-center">
					<div class="author-img" style="background-image: url(assets/images/mine.jpg);"></div>
					<h1 id="colorlib-logo"><a href="index.html">Seto Dwiki Kurniawan</a></h1>
